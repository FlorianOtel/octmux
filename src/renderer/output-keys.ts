...
//      - Permitted side effect (Version 4.5.2): on `on=true`, kick a
...
//        _ensureWindow, invoked EXCLUSIVELY from beginBlock (the Version 4.4.3
//        load-bearing path). Re-entry safety and async liveness caching
//        (Version 4.4.4) live there.
...
//
// 3. WHY the strict invariant exists: Version 4.5 (commit 25c644a) tried
...
//    call interacted badly with the Version 4.4.4 async liveness cache and
//    broke streaming to the re-created window. The behavior was reverted
//    in Version 4.5.1; see docs/Version4.md for the full post-mortem. The
//    lazy-on-block-start UX (window appears on the next matching block,
//    not on toggle) is the accepted trade-off.
//
// 4. WHY the Version 4.5.2 cache-refresh exception exists: with strict
//    Version 4.5.1, an operator who toggled off, killed the window manually,
...
//    a follow-up prompt takes seconds). See docs/Version4.md §Version 4.5.2
